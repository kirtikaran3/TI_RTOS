Example Summary
------------------
This application exercises the System Analyzers CPU Load, Task Load
...
, 25, 50, 75 and 95 percent of the CPU load.

timerFunc(), a Hwi thread, runs every 1ms and launches
