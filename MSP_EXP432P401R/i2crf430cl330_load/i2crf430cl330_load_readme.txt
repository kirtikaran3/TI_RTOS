...
| ================= | ====================================================== |
| DK-TM4C129X       | This example was designed to use the DLP-RF430BP       |
| EK-TM4C123GXL     | Booster Pack (which contains the RF430CL330H).         |
| EK-TM4C1294XL     | The booster pack is required to successfully complete  |
| EK-TM4C129EXL     | this example.                                          |
| MSP-EXP430F5529LP | A NFC transceiver (such as a NFC enabled smart-phone)  |
| MSP-EXP430FR5969  | is required to recover CPU load data.                  |
| MSP-EXP430FR6989  |                                                        |
| MSP-EXP432P401R   |                                                        |
| ----------------- | ------------------------------------------------------ |
...
buffer.  These can be viewed by stopping the target and opening SysMin in
ROV.
